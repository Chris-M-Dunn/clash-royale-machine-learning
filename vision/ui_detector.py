...
class UIDetector:
    ...
    def run_ui_detection(self, stop_event):
        ...
        while not stop_event.is_set():
            ...
            next_card_img = cv_image[
                self.NEXT_CARD_BOX[1]:self.NEXT_CARD_BOX[3],
                self.NEXT_CARD_BOX[0]:self.NEXT_CARD_BOX[2]
            ]
            outer_left_img = cv_image[
                self.OUTER_LEFT_CARD_BOX[1]:self.OUTER_LEFT_CARD_BOX[3],
                self.OUTER_LEFT_CARD_BOX[0]:self.OUTER_LEFT_CARD_BOX[2]
            ]

            cv2.imwrite("debug_next.png", next_card_img)
            cv2.imwrite("debug_outer_left.png", outer_left_img)
